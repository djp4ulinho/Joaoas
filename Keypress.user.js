...
function run() {
    ...
    if (checkCookie()) {
        if ($.cookie(cookieName)
            ...
            UI.ErrorMessage("A cause d'une mise a jour, les donnÃƒÆ’Ã‚Â©es ont ÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â©s perdues. Veuillez recommencer les assignations de touches.", 500);
        ...
        UI.SuccessMessage("Bienvenue sur le Fakeypress de Crimsoni", 50);
        resetCookie();
    }
